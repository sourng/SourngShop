...
class corders extends cTable {
	...
	function __construct() {
		...
		// user_id
		$this->user_id = new cField('orders', 'orders', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// product_id
		$this->product_id = new cField('orders', 'orders', 'x_product_id', 'product_id', '`product_id`', '`product_id`', 3, -1, FALSE, '`product_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// p_status
		$this->p_status = new cField('orders', 'orders', 'x_p_status', 'p_status', '`p_status`', '`p_status`', 200, -1, FALSE, '`p_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->p_status->Sortable = TRUE; // Allow sort
		$this->p_status->OptionCount = 2;
