...
<?php if ($categories->cat_title->Visible) { // cat_title ?>
		<th class="<?php echo $categories->cat_title->HeaderCellClass() ?>"><span id="elh_categories_cat_title" class="categories_cat_title"><?php echo $categories->cat_title->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($categories->cat_title->Visible) { // cat_title ?>
		<td<?php echo $categories->cat_title->CellAttributes() ?>>
<span id="el<?php echo $categories_delete->RowCnt ?>_categories_cat_title" class="categories_cat_title">
