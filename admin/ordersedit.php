...
fordersedit.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_first_name","x_last_name","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"user_info"};
fordersedit.Lists["x_user_id"].Data = "<?php echo $orders_edit->user_id->LookupFilterQuery(FALSE, "edit") ?>";
fordersedit.Lists["x_product_id"] = {"LinkField":"x_product_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_product_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"products"};
fordersedit.Lists["x_product_id"].Data = "<?php echo $orders_edit->product_id->LookupFilterQuery(FALSE, "edit") ?>";
fordersedit.Lists["x_p_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fordersedit.Lists["x_p_status"].Options = <?php echo json_encode($orders_edit->p_status->Options()) ?>;
...
<?php if ($orders->p_status->Visible) { // p_status ?>
	<div id="r_p_status" class="form-group">
		<label id="elh_orders_p_status" class="<?php echo $orders_edit->LeftColumnClass ?>"><?php echo $orders->p_status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
