...
define("EW_PROJECT_NAME", "SourngShop", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{DE3D48ED-60FB-4F03-A5AD-139B7A8A8A85}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '1DGpZf2iJ92ZfCrX', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/SourngShop.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sourngshop", "qs" => "`", "qe" => "`");
...
define("EW_UPLOAD_DEST_PATH", "../product_images/", TRUE); // Upload destination path (relative to app root)
