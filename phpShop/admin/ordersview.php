...
fordersview.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_first_name","x_last_name","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"user_info"};
fordersview.Lists["x_user_id"].Data = "<?php echo $orders_view->user_id->LookupFilterQuery(FALSE, "view") ?>";
fordersview.Lists["x_product_id"] = {"LinkField":"x_product_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_product_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"products"};
fordersview.Lists["x_product_id"].Data = "<?php echo $orders_view->product_id->LookupFilterQuery(FALSE, "view") ?>";
fordersview.Lists["x_p_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fordersview.Lists["x_p_status"].Options = <?php echo json_encode($orders_view->p_status->Options()) ?>;
