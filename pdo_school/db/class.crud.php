/*
* create class name : class.crud.php
* place it in location or folder : class/class.crud.php
*/
<?php
class crud
{
...
/* get Maketing */
	public function getMaketing($query)
	{
			...
			while($row=$stmt->fetch(PDO::FETCH_ASSOC))
			{
				...
				<div class="col-lg-4 mb-4">
				    <div class="card h-100">
				      ...
				      <img style="width: 100%;" src="./uploads/img/<?php print($row['image']); ?>" alt="">
				      <div class="card-body">
