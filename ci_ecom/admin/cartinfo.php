...
//
// Table class for cart
//
class ccart extends cTable {
	var $id;
	var $p_id;
	var $ip_add;
	var $user_id;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('cart', 'cart', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// p_id
		$this->p_id = new cField('cart', 'cart', 'x_p_id', 'p_id', '`p_id`', '`p_id`', 3, -1, FALSE, '`p_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->p_id->Sortable = TRUE; // Allow sort
		$this->p_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['p_id'] = &$this->p_id;

		// ip_add
		$this->ip_add = new cField('cart', 'cart', 'x_ip_add', 'ip_add', '`ip_add`', '`ip_add`', 200, -1, FALSE, '`ip_add`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ip_add->Sortable = TRUE; // Allow sort
		$this->fields['ip_add'] = &$this->ip_add;

		// user_id
		$this->user_id = new cField('cart', 'cart', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->Sortable = TRUE; // Allow sort
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// qty
		$this->qty = new cField('cart', 'cart', 'x_qty', 'qty', '`qty`', '`qty`', 3, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cart`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "cartedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "cartadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cartview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cartview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "cartadd.php?" . $this->UrlParm($parm);
		else
			$url = "cartadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("cartedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("cartadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cartdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->ip_add->setDbValue($rs->fields('ip_add'));
	...
	function RenderEditRow() {
		...
		$this->ip_add->EditValue = $this->ip_add->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->ip_add->Exportable) $Doc->ExportCaption($this->ip_add);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->ip_add->Exportable) $Doc->ExportField($this->ip_add);
