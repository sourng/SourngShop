...
class cproducts_add extends cproducts {
	...
	function LoadDefaultValues() {
		...
		$this->product_dist->CurrentValue = NULL;
		$this->product_dist->OldValue = $this->product_dist->CurrentValue;
		...
		$this->product_image1->Upload->DbValue = NULL;
		$this->product_image1->OldValue = $this->product_image1->Upload->DbValue;
		$this->product_image1->CurrentValue = NULL; // Clear file related field
		$this->product_image2->Upload->DbValue = NULL;
		$this->product_image2->OldValue = $this->product_image2->Upload->DbValue;
		$this->product_image2->CurrentValue = NULL; // Clear file related field
		$this->product_image3->Upload->DbValue = NULL;
		$this->product_image3->OldValue = $this->product_image3->Upload->DbValue;
		$this->product_image3->CurrentValue = NULL; // Clear file related field
		$this->top_sell->CurrentValue = NULL;
		$this->top_sell->OldValue = $this->top_sell->CurrentValue;
	...
	function NewRow() {
		...
		$row['product_dist'] = $this->product_dist->CurrentValue;
		$row['product_desc'] = $this->product_desc->CurrentValue;
		$row['product_image'] = $this->product_image->Upload->DbValue;
		$row['product_image1'] = $this->product_image1->Upload->DbValue;
		$row['product_image2'] = $this->product_image2->Upload->DbValue;
		$row['product_image3'] = $this->product_image3->Upload->DbValue;
		$row['top_sell'] = $this->top_sell->CurrentValue;
	...
	function RenderRow() {
		...
		$this->product_keywords->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->product_image1);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->product_image2);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->product_image3);
	...
	function AddRow($rsold = NULL) {
		...
		// product_dist
		$this->product_dist->SetDbValueDef($rsnew, $this->product_dist->CurrentValue, 0, FALSE);
		...
		if ($this->product_image1->Visible && !$this->product_image1->Upload->KeepFile) {
			$this->product_image1->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->product_image2->Visible && !$this->product_image2->Upload->KeepFile) {
			$this->product_image2->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->product_image3->Visible && !$this->product_image3->Upload->KeepFile) {
			$this->product_image3->Upload->DbValue = ""; // No need to delete old file
		...
		// top_sell
		$this->top_sell->SetDbValueDef($rsnew, $this->top_sell->CurrentValue, 0, FALSE);

		// condition
		$this->condition->SetDbValueDef($rsnew, $this->condition->CurrentValue, "", FALSE);
		...
		if ($this->product_image1->Visible && !$this->product_image1->Upload->KeepFile) {
			...
			if (!ew_Empty($this->product_image1->Upload->FileName)) {
				...
				$this->product_image1->SetDbValueDef($rsnew, $this->product_image1->Upload->FileName, "", FALSE);
			}
		}
		if ($this->product_image2->Visible && !$this->product_image2->Upload->KeepFile) {
			$this->product_image2->UploadPath = "../uploads/product/";
			...
			if (!ew_Empty($this->product_image2->Upload->FileName)) {
				...
				$this->product_image2->SetDbValueDef($rsnew, $this->product_image2->Upload->FileName, "", FALSE);
			}
		}
		if ($this->product_image3->Visible && !$this->product_image3->Upload->KeepFile) {
			$this->product_image3->UploadPath = "../uploads/product/";
			...
			if (!ew_Empty($this->product_image3->Upload->FileName)) {
				...
				$this->product_image3->SetDbValueDef($rsnew, $this->product_image3->Upload->FileName, "", FALSE);
			}
		}
...
fproductsadd.Lists["x_product_brand"] = {"LinkField":"x_brand_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_brand_title","","",""],"ParentFields":[],"ChildFields":["x_product_cat"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"brands"};
fproductsadd.Lists["x_product_brand"].Data = "<?php echo $products_add->product_brand->LookupFilterQuery(FALSE, "add") ?>";
fproductsadd.Lists["x_product_cat"] = {"LinkField":"x_cat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_cat_title","","",""],"ParentFields":["x_product_brand"],"ChildFields":[],"FilterFields":["x_brand_id"],"Options":[],"Template":"","LinkTable":"categories"};
fproductsadd.Lists["x_product_cat"].Data = "<?php echo $products_add->product_cat->LookupFilterQuery(FALSE, "add") ?>";
fproductsadd.Lists["x_top_sell"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductsadd.Lists["x_top_sell"].Options = <?php echo json_encode($products_add->top_sell->Options()) ?>;
fproductsadd.Lists["x_condition"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductsadd.Lists["x_condition"].Options = <?php echo json_encode($products_add->condition->Options()) ?>;
...
<?php if ($products->product_dist->Visible) { // product_dist ?>
	<div id="r_product_dist" class="form-group">
		<label id="elh_products_product_dist" for="x_product_dist" class="<?php echo $products_add->LeftColumnClass ?>"><?php echo $products->product_dist->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $products_add->RightColumnClass ?>"><div<?php echo $products->product_dist->CellAttributes() ?>>
...
<?php if ($products->product_desc->Visible) { // product_desc ?>
	<div id="r_product_desc" class="form-group">
		<label id="elh_products_product_desc" class="<?php echo $products_add->LeftColumnClass ?>"><?php echo $products->product_desc->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<script type="text/javascript">
ew_CreateEditor("fproductsadd", "x_product_desc", 35, 4, <?php echo ($products->product_desc->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($products->product_image1->Visible) { // product_image1 ?>
	<div id="r_product_image1" class="form-group">
		<label id="elh_products_product_image1" class="<?php echo $products_add->LeftColumnClass ?>"><?php echo $products->product_image1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $products_add->RightColumnClass ?>"><div<?php echo $products->product_image1->CellAttributes() ?>>
...
<?php if ($products->product_image2->Visible) { // product_image2 ?>
	<div id="r_product_image2" class="form-group">
		<label id="elh_products_product_image2" class="<?php echo $products_add->LeftColumnClass ?>"><?php echo $products->product_image2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $products_add->RightColumnClass ?>"><div<?php echo $products->product_image2->CellAttributes() ?>>
...
<?php if ($products->product_image3->Visible) { // product_image3 ?>
	<div id="r_product_image3" class="form-group">
		<label id="elh_products_product_image3" class="<?php echo $products_add->LeftColumnClass ?>"><?php echo $products->product_image3->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $products_add->RightColumnClass ?>"><div<?php echo $products->product_image3->CellAttributes() ?>>
...
<?php if ($products->top_sell->Visible) { // top_sell ?>
	<div id="r_top_sell" class="form-group">
		<label id="elh_products_top_sell" class="<?php echo $products_add->LeftColumnClass ?>"><?php echo $products->top_sell->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $products_add->RightColumnClass ?>"><div<?php echo $products->top_sell->CellAttributes() ?>>
...
<?php if ($products->condition->Visible) { // condition ?>
	<div id="r_condition" class="form-group">
		<label id="elh_products_condition" class="<?php echo $products_add->LeftColumnClass ?>"><?php echo $products->condition->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $products_add->RightColumnClass ?>"><div<?php echo $products->condition->CellAttributes() ?>>
