...
define("EW_PROJECT_NAME", "ShopAdmin", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{35B667F0-3972-4C72-8E88-51DD671EF082}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'O1gcau9dGqeIHX8f', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/ShopAdmin.css", TRUE); // Project stylesheet file name
...
define("EW_USER_TABLE", "`user_info`", TRUE);
