...
$cart_edit = NULL; // Initialize page object first

class ccart_edit extends ccart {
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("cartlist.php"); // Return to list page
...
// Create page object
if (!isset($cart_edit)) $cart_edit = new ccart_edit();
...
var CurrentForm = fcartedit = new ew_Form("fcartedit", "edit");
...
fcartedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if (!isset($cart_edit->Pager)) $cart_edit->Pager = new cPrevNextPager($cart_edit->StartRec, $cart_edit->DisplayRecs, $cart_edit->TotalRecs, $cart_edit->AutoHidePager) ?>
<?php if ($cart_edit->Pager->RecordCount > 0 && $cart_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($cart_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $cart_edit->PageUrl() ?>start=<?php echo $cart_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($cart_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $cart_edit->PageUrl() ?>start=<?php echo $cart_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $cart_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($cart_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $cart_edit->PageUrl() ?>start=<?php echo $cart_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($cart_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $cart_edit->PageUrl() ?>start=<?php echo $cart_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $cart_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fcartedit" id="fcartedit" class="<?php echo $cart_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cart_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cart_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cart">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($cart_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($cart->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_cart_id" class="<?php echo $cart_edit->LeftColumnClass ?>"><?php echo $cart->id->FldCaption() ?></label>
		<div class="<?php echo $cart_edit->RightColumnClass ?>"><div<?php echo $cart->id->CellAttributes() ?>>
<span id="el_cart_id">
<span<?php echo $cart->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $cart->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="cart" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($cart->id->CurrentValue) ?>">
<?php echo $cart->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($cart->p_id->Visible) { // p_id ?>
	<div id="r_p_id" class="form-group">
		<label id="elh_cart_p_id" for="x_p_id" class="<?php echo $cart_edit->LeftColumnClass ?>"><?php echo $cart->p_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cart_edit->RightColumnClass ?>"><div<?php echo $cart->p_id->CellAttributes() ?>>
...
<?php if ($cart->ip_add->Visible) { // ip_add ?>
	<div id="r_ip_add" class="form-group">
		<label id="elh_cart_ip_add" for="x_ip_add" class="<?php echo $cart_edit->LeftColumnClass ?>"><?php echo $cart->ip_add->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cart_edit->RightColumnClass ?>"><div<?php echo $cart->ip_add->CellAttributes() ?>>
...
<?php if ($cart->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_cart_user_id" for="x_user_id" class="<?php echo $cart_edit->LeftColumnClass ?>"><?php echo $cart->user_id->FldCaption() ?></label>
		<div class="<?php echo $cart_edit->RightColumnClass ?>"><div<?php echo $cart->user_id->CellAttributes() ?>>
...
<?php if ($cart->qty->Visible) { // qty ?>
	<div id="r_qty" class="form-group">
		<label id="elh_cart_qty" for="x_qty" class="<?php echo $cart_edit->LeftColumnClass ?>"><?php echo $cart->qty->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cart_edit->RightColumnClass ?>"><div<?php echo $cart->qty->CellAttributes() ?>>
<span id="el_cart_qty">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cart_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
