...
<?php if ($categories->brand_id->Visible) { // brand_id ?>
		<th class="<?php echo $categories->brand_id->HeaderCellClass() ?>"><span id="elh_categories_brand_id" class="categories_brand_id"><?php echo $categories->brand_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($categories->brand_id->Visible) { // brand_id ?>
		<td<?php echo $categories->brand_id->CellAttributes() ?>>
<span id="el<?php echo $categories_delete->RowCnt ?>_categories_brand_id" class="categories_brand_id">
