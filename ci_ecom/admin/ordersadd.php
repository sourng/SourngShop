...
<?php if ($orders->p_status->Visible) { // p_status ?>
	<div id="r_p_status" class="form-group">
		<label id="elh_orders_p_status" for="x_p_status" class="<?php echo $orders_add->LeftColumnClass ?>"><?php echo $orders->p_status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
