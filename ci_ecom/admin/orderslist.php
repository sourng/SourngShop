...
<?php if ($orders->p_status->Visible) { // p_status ?>
	...
	<?php } else { ?>
		<th data-name="p_status" class="<?php echo $orders->p_status->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $orders->SortUrl($orders->p_status) ?>',1);"><div id="elh_orders_p_status" class="orders_p_status">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $orders->p_status->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($orders->p_status->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($orders->p_status->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
