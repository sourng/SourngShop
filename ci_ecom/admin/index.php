...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'brands'))
		$this->Page_Terminate("brandslist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'cart'))
			$this->Page_Terminate("cartlist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'user_info'))
			$this->Page_Terminate("user_infolist.php");
