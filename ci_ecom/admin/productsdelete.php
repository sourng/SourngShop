	...
	function DeleteRows() {
		...
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$OldFiles = ew_Empty($row['product_image1']) ? array() : array($row['product_image1']);
				$OldFileCount = count($OldFiles);
				for ($i = 0; $i < $OldFileCount; $i++) {
					if (file_exists($this->product_image1->OldPhysicalUploadPath() . $OldFiles[$i]))
						@unlink($this->product_image1->OldPhysicalUploadPath() . $OldFiles[$i]);
				}
				$this->product_image2->OldUploadPath = "../uploads/product/";
				$OldFiles = ew_Empty($row['product_image2']) ? array() : array($row['product_image2']);
				$OldFileCount = count($OldFiles);
				for ($i = 0; $i < $OldFileCount; $i++) {
					if (file_exists($this->product_image2->OldPhysicalUploadPath() . $OldFiles[$i]))
						@unlink($this->product_image2->OldPhysicalUploadPath() . $OldFiles[$i]);
				}
				$this->product_image3->OldUploadPath = "../uploads/product/";
				$OldFiles = ew_Empty($row['product_image3']) ? array() : array($row['product_image3']);
				$OldFileCount = count($OldFiles);
				for ($i = 0; $i < $OldFileCount; $i++) {
					if (file_exists($this->product_image3->OldPhysicalUploadPath() . $OldFiles[$i]))
...
fproductsdelete.Lists["x_product_brand"] = {"LinkField":"x_brand_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_brand_title","","",""],"ParentFields":[],"ChildFields":["x_product_cat"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"brands"};
...
fproductsdelete.Lists["x_top_sell"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductsdelete.Lists["x_top_sell"].Options = <?php echo json_encode($products_delete->top_sell->Options()) ?>;
fproductsdelete.Lists["x_condition"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductsdelete.Lists["x_condition"].Options = <?php echo json_encode($products_delete->condition->Options()) ?>;
...
<?php if ($products->product_dist->Visible) { // product_dist ?>
		<th class="<?php echo $products->product_dist->HeaderCellClass() ?>"><span id="elh_products_product_dist" class="products_product_dist"><?php echo $products->product_dist->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($products->top_sell->Visible) { // top_sell ?>
		<th class="<?php echo $products->top_sell->HeaderCellClass() ?>"><span id="elh_products_top_sell" class="products_top_sell"><?php echo $products->top_sell->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->condition->Visible) { // condition ?>
		<th class="<?php echo $products->condition->HeaderCellClass() ?>"><span id="elh_products_condition" class="products_condition"><?php echo $products->condition->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($products->product_dist->Visible) { // product_dist ?>
		<td<?php echo $products->product_dist->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_product_dist" class="products_product_dist">
...
<?php } ?>
<?php if ($products->top_sell->Visible) { // top_sell ?>
		<td<?php echo $products->top_sell->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_top_sell" class="products_top_sell">
...
<?php } ?>
<?php if ($products->condition->Visible) { // condition ?>
		<td<?php echo $products->condition->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_condition" class="products_condition">
