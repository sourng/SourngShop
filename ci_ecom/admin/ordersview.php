...
<?php if ($orders->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td class="col-sm-2"><span id="elh_orders_user_id"><?php echo $orders->user_id->FldCaption() ?></span></td>
...
<?php echo $orders->user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->product_id->Visible) { // product_id ?>
	<tr id="r_product_id">
		<td class="col-sm-2"><span id="elh_orders_product_id"><?php echo $orders->product_id->FldCaption() ?></span></td>
...
<?php echo $orders->product_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->qty->Visible) { // qty ?>
	<tr id="r_qty">
		<td class="col-sm-2"><span id="elh_orders_qty"><?php echo $orders->qty->FldCaption() ?></span></td>
		<td data-name="qty"<?php echo $orders->qty->CellAttributes() ?>>
<span id="el_orders_qty">
<span<?php echo $orders->qty->ViewAttributes() ?>>
<?php echo $orders->qty->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->trx_id->Visible) { // trx_id ?>
	<tr id="r_trx_id">
		<td class="col-sm-2"><span id="elh_orders_trx_id"><?php echo $orders->trx_id->FldCaption() ?></span></td>
...
<?php echo $orders->trx_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->p_status->Visible) { // p_status ?>
	<tr id="r_p_status">
		<td class="col-sm-2"><span id="elh_orders_p_status"><?php echo $orders->p_status->FldCaption() ?></span></td>
...
<?php echo $orders->p_status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
