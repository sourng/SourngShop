...
//
// Table class for user_info
//
class cuser_info extends cTable {
	var $user_id;
	var $first_name;
	var $last_name;
	var $_email;
	...
	function __construct() {
		...
		$this->TableVar = 'user_info';
		$this->TableName = 'user_info';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`user_info`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// user_id
		$this->user_id = new cField('user_info', 'user_info', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->user_id->Sortable = TRUE; // Allow sort
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// first_name
		$this->first_name = new cField('user_info', 'user_info', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, -1, FALSE, '`first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->first_name->Sortable = TRUE; // Allow sort
		$this->fields['first_name'] = &$this->first_name;

		// last_name
		$this->last_name = new cField('user_info', 'user_info', 'x_last_name', 'last_name', '`last_name`', '`last_name`', 200, -1, FALSE, '`last_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->last_name->Sortable = TRUE; // Allow sort
		$this->fields['last_name'] = &$this->last_name;

		// email
		$this->_email = new cField('user_info', 'user_info', 'x__email', 'email', '`email`', '`email`', 201, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// password
		$this->password = new cField('user_info', 'user_info', 'x_password', 'password', '`password`', '`password`', 201, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->password->Sortable = TRUE; // Allow sort
		$this->fields['password'] = &$this->password;

		// mobile
		$this->mobile = new cField('user_info', 'user_info', 'x_mobile', 'mobile', '`mobile`', '`mobile`', 200, -1, FALSE, '`mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile->Sortable = TRUE; // Allow sort
		$this->fields['mobile'] = &$this->mobile;

		// address1
		$this->address1 = new cField('user_info', 'user_info', 'x_address1', 'address1', '`address1`', '`address1`', 201, -1, FALSE, '`address1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->address1->Sortable = TRUE; // Allow sort
		$this->fields['address1'] = &$this->address1;

		// address2
		$this->address2 = new cField('user_info', 'user_info', 'x_address2', 'address2', '`address2`', '`address2`', 200, -1, FALSE, '`address2`', FALSE, FALSE, FALSE, 'IMAGE', 'RADIO');
		$this->address2->Sortable = TRUE; // Allow sort
		$this->address2->OptionCount = 2;
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`user_info`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "user_infoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "user_infoadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("user_infoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("user_infoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "user_infoadd.php?" . $this->UrlParm($parm);
		else
			$url = "user_infoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("user_infoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("user_infoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("user_infodelete.php", $this->UrlParm());
	}
