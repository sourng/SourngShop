...
class ccategories_list extends ccategories {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 2) {
			...
			if (!is_numeric($this->cat_id->FormValue))
				return FALSE;
			$this->brand_id->setFormValue($arrKeyFlds[1]);
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ewMultiSelect\" value=\"" . ew_HtmlEncode($this->cat_id->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->brand_id->CurrentValue) . "\" onclick=\"ew_ClickMultiCheckbox(event);\">";
...
<?php if ($categories->brand_id->Visible) { // brand_id ?>
	<?php if ($categories->SortUrl($categories->brand_id) == "") { ?>
		<th data-name="brand_id" class="<?php echo $categories->brand_id->HeaderCellClass() ?>"><div id="elh_categories_brand_id" class="categories_brand_id"><div class="ewTableHeaderCaption"><?php echo $categories->brand_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="brand_id" class="<?php echo $categories->brand_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $categories->SortUrl($categories->brand_id) ?>',1);"><div id="elh_categories_brand_id" class="categories_brand_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $categories->brand_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($categories->brand_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($categories->brand_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php echo $categories->cat_id->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($categories->brand_id->Visible) { // brand_id ?>
		<td data-name="brand_id"<?php echo $categories->brand_id->CellAttributes() ?>>
<span id="el<?php echo $categories_list->RowCnt ?>_categories_brand_id" class="categories_brand_id">
<span<?php echo $categories->brand_id->ViewAttributes() ?>>
<?php echo $categories->brand_id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
