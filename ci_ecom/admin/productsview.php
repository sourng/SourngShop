...
fproductsview.Lists["x_product_brand"] = {"LinkField":"x_brand_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_brand_title","","",""],"ParentFields":[],"ChildFields":["x_product_cat"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"brands"};
...
fproductsview.Lists["x_top_sell"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductsview.Lists["x_top_sell"].Options = <?php echo json_encode($products_view->top_sell->Options()) ?>;
fproductsview.Lists["x_condition"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductsview.Lists["x_condition"].Options = <?php echo json_encode($products_view->condition->Options()) ?>;
...
<?php if ($products->product_dist->Visible) { // product_dist ?>
	<tr id="r_product_dist">
		<td class="col-sm-2"><span id="elh_products_product_dist"><?php echo $products->product_dist->FldCaption() ?></span></td>
...
<?php echo $products->product_dist->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($products->product_image1->Visible) { // product_image1 ?>
	<tr id="r_product_image1">
		<td class="col-sm-2"><span id="elh_products_product_image1"><?php echo $products->product_image1->FldCaption() ?></span></td>
		<td data-name="product_image1"<?php echo $products->product_image1->CellAttributes() ?>>
<span id="el_products_product_image1">
<span>
<?php echo ew_GetFileViewTag($products->product_image1, $products->product_image1->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($products->product_image2->Visible) { // product_image2 ?>
	<tr id="r_product_image2">
		<td class="col-sm-2"><span id="elh_products_product_image2"><?php echo $products->product_image2->FldCaption() ?></span></td>
		<td data-name="product_image2"<?php echo $products->product_image2->CellAttributes() ?>>
<span id="el_products_product_image2">
<span>
<?php echo ew_GetFileViewTag($products->product_image2, $products->product_image2->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($products->product_image3->Visible) { // product_image3 ?>
	<tr id="r_product_image3">
		<td class="col-sm-2"><span id="elh_products_product_image3"><?php echo $products->product_image3->FldCaption() ?></span></td>
		<td data-name="product_image3"<?php echo $products->product_image3->CellAttributes() ?>>
<span id="el_products_product_image3">
<span>
<?php echo ew_GetFileViewTag($products->product_image3, $products->product_image3->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($products->top_sell->Visible) { // top_sell ?>
	<tr id="r_top_sell">
		<td class="col-sm-2"><span id="elh_products_top_sell"><?php echo $products->top_sell->FldCaption() ?></span></td>
...
<?php echo $products->top_sell->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($products->condition->Visible) { // condition ?>
	<tr id="r_condition">
		<td class="col-sm-2"><span id="elh_products_condition"><?php echo $products->condition->FldCaption() ?></span></td>
...
<?php echo $products->condition->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
