...
fuser_infoedit.Lists["x_address2"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuser_infoedit.Lists["x_address2"].Options = <?php echo json_encode($user_info_edit->address2->Options()) ?>;
...
<?php if (!isset($user_info_edit->Pager)) $user_info_edit->Pager = new cPrevNextPager($user_info_edit->StartRec, $user_info_edit->DisplayRecs, $user_info_edit->TotalRecs, $user_info_edit->AutoHidePager) ?>
<?php if ($user_info_edit->Pager->RecordCount > 0 && $user_info_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($user_info_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $user_info_edit->PageUrl() ?>start=<?php echo $user_info_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($user_info_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $user_info_edit->PageUrl() ?>start=<?php echo $user_info_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $user_info_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($user_info_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $user_info_edit->PageUrl() ?>start=<?php echo $user_info_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($user_info_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $user_info_edit->PageUrl() ?>start=<?php echo $user_info_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $user_info_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
...
<?php if ($user_info->address2->Visible) { // address2 ?>
	<div id="r_address2" class="form-group">
		<label id="elh_user_info_address2" class="<?php echo $user_info_edit->LeftColumnClass ?>"><?php echo $user_info->address2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
